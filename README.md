# 123 Multidisciplinary Engineering & Skill-Building Projects

Welcome to `lab` (formerly `brainstorm`) — a curated portfolio of 123 engineering and skill-building
...
The 122 projects are divided into the following categories:

1. **[Audio & MIDI](01-audio-midi/projects.md)** (17 Projects) - DSP, custom controllers, and audio
   hardware.
...
6. **[Coffee & Espresso](06-coffee-espresso/projects.md)** (18 Projects) - Lucca A53 profiling,
